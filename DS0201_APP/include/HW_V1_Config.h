...
#define LCD_DATA_BUS_INP()  GPIOE_CRH = 0x44444444; GPIOE_CRL = 0x44444444
#define LCD_DATA_BUS_OUT()  GPIOE_CRH = 0x33333333; GPIOE_CRL = 0x33333333
...
#define LCD_nRD_ACT()   GPIOD_BRR  = GPIO_Pin_4; GPIOD_BSRR = GPIO_Pin_4
